...
namespace GUI
{
    public partial class fmNhanPhong : DevExpress.XtraEditors.XtraForm
    {
        ...
        public fmNhanPhong(List<tb_Phong> phongs)
        {
            InitializeComponent();
            Phongs = phongs;
            ...
            checkOut = new DateTime(checkIn.Year, checkIn.Month, checkIn.Day , 14, 0, 0);
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                DatPhongBLL.Checkin(PhieuDatPhong, ctDatPhongs, totalAmount);
                Close();
            }
            catch (Exception ex)
            {
